#line 1 "..\\API\\API_Lib\\rak_spi_server.c"
...
typedef struct {
	...
	rak_scan				uScanFrame;				
	rak_psk				uPskFrame;
	rak_set_power_mode    upowermodeFrame;
	rak_conn_t			uConnectFrame;
	rak_ipconfig_t 	uIpconfigFrame;
...
#line 214 "..\\API\\API_Lib\\rak_global.h"
...
uint16_t rak_powermode(rak_set_power_mode *PowerFrame);
uint16_t rak_connect(rak_conn_t *ConnectFrame);
uint16_t rak_get_version(void);
uint16_t rak_null(void);
uint16_t rak_get_net_status(void);
uint16_t rak_get_rssi(void);
uint16_t rak_ipconfig_dhcp(rak_ipconfig_t *IpconfigFrame);
...
#line 29 "..\\API\\API_Lib\\rak_spi_server.c"

#line 31 "..\\API\\API_Lib\\rak_spi_server.c"
...
#line 32 "..\\API\\API_Lib\\rak_spi_server.c"
...
uint16_t rak_tcp_server(rak_server_t *ServerFrame)
{
	...
	ServerFrame->cmd = 18;
	retval =  RAK_SndCMD(ServerFrame, sizeof(rak_server_t));
	return retval;
}
