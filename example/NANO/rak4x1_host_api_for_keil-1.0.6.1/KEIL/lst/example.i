...
#line 13 "..\\User\\example.c"
#line 14 "..\\User\\example.c"
#line 1 "..\\API\\API_Lib\\include\\rak411_api.h"


#line 15 "..\\User\\example.c"
...
uint8_t 	 	Send_RecieveDataFlag=0;
...
int main(void)
{
	...
	rak_open_socket(25000,25000,1,(uint32_t)DIST_IP);
		
	while(1)
	{	
	   if ((GPIO_GetBit (((GPIO_TypeDef *) (((0x40000000UL) + 0x10000000) + 0x04040)),14)))
	   {
			if 	(rak_checkPktIrq()==1)
			{
				rak_read_packet(&uCmdRspFrame);
				rak_clearPktIrq();
				if (uCmdRspFrame.rspCode[0]==0xC9)
				{
				   	socket_flag = uCmdRspFrame.recvsocketEst.socket_flag ;
				}
				else if (uCmdRspFrame.rspCode[0]==0xCA)
				{
					 socket_flag=-1;
				}
      		}
