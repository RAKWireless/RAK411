#line 1 "..\\API\\API_Lib\\src\\rak_spi_interrupt_handler.c"
...
#line 7 "..\\API\\API_Lib\\src\\rak_spi_interrupt_handler.c"
...
#line 8 "..\\API\\API_Lib\\src\\rak_spi_interrupt_handler.c"
#line 9 "..\\API\\API_Lib\\src\\rak_spi_interrupt_handler.c"
...
#line 10 "..\\API\\API_Lib\\src\\rak_spi_interrupt_handler.c"
...
uint8_t rak_intHandler(void)
{
	int16_t					status;
		...
		if(status&0x01)
			rak_strIntStatus.dataPacketPending	 =1;
		if(status&0X02)
			rak_strIntStatus.recvFull = 1;
		if(status&0X08)
			rak_strIntStatus.sendFull = 1;
		if(status&0x04)
            rak_strIntStatus.upgrad_err=1;
