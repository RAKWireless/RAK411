#line 1 "..\\API\\API_Lib\\src\\rak_spi_open_socket.c"
...
#line 7 "..\\API\\API_Lib\\src\\rak_spi_open_socket.c"
...
int16_t rak_init_struct(rak_api *ptrStrApi);
#line 8 "..\\API\\API_Lib\\src\\rak_spi_open_socket.c"
...
#line 9 "..\\API\\API_Lib\\src\\rak_spi_open_socket.c"
...
#line 10 "..\\API\\API_Lib\\src\\rak_spi_open_socket.c"
#line 11 "..\\API\\API_Lib\\src\\rak_spi_open_socket.c"
#line 12 "..\\API\\API_Lib\\src\\rak_spi_open_socket.c"
...
uint16_t rak_socket(uint16_t local_Port,uint16_t dest_Port,
						uint8_t rak_SocketCmd,uint32_t dest_Ip)

{
	...
	{
	  case 0x00: 
							ClientFrame.cmd	=	0xB3;
							ClientFrame.dest_addr = dest_Ip;
							ClientFrame.dest_port	=	dest_Port;
							ClientFrame.local_port	=	local_Port;	
							retval =  RAK_SendCMD(0xB3,&ClientFrame, sizeof(rak_client_t));
							
							break;
	  case 0x01: 
							ServerFrame.cmd	=	0xB4;
							ServerFrame.dummy = 0;
							ServerFrame.port	=	local_Port;	
							retval =  RAK_SendCMD(0xB4,&ServerFrame, sizeof(rak_server_t));
										
							break;
	  case 0x02: 
							ClientFrame.cmd	=	0xB1;
							ClientFrame.dest_addr = dest_Ip;
							ClientFrame.dest_port	=	dest_Port;
							ClientFrame.local_port	=	local_Port;	
							retval =  RAK_SendCMD(0xB1,&ClientFrame, sizeof(rak_client_t));
							
							break;
	  case 0x03: 
							ServerFrame.cmd	=	0xB2;
							ServerFrame.dummy = 0;
							ServerFrame.port	=	local_Port;	
							retval =  RAK_SendCMD(0xB2,&ServerFrame, sizeof(rak_server_t));			
							break;
	  case 0x04: 
							ClientFrame.cmd	=	0xC4;
							ClientFrame.dest_addr = dest_Ip;
							ClientFrame.dest_port	=	dest_Port;
							ClientFrame.local_port	=	local_Port;
							retval =  RAK_SendCMD(0xC4,&ClientFrame, sizeof(rak_client_t));			
							break;		
	}	
	return retval;
}
...
uint16_t rak_open_socket(uint16_t local_Port,uint16_t dest_Port,
						uint8_t rak_SocketCmd,uint32_t dest_Ip)
{
uint16_t retval;
	...
	if(retval!=0X00)
  	...
  	{    					  
	    rak_spiTimer3=0; while (rak_checkPktIrq() != 1) { SYS_Delay(100); if (rak_spiTimer3++ > (uint32_t)50 * 2500) { retval = 1; break; } };
	    rak_read_packet(&uCmdRspFrame);
		printf ("Open Sockt OK.\r\n");
		rak_clearPktIrq();
  	}
	 return retval;
