...
#line 11 "..\\User\\hal_init.c"
#line 1 "..\\API\\API_Lib\\include\\rak_hal.h"





#line 7 "..\\API\\API_Lib\\include\\rak_hal.h"
#line 8 "..\\API\\API_Lib\\include\\rak_hal.h"
...
void UART1_Init(void)
{
    ...
    (((GCR_TypeDef *) (((0x40000000UL) + 0x10000000) + 0x00000))->PB_L_MFP = ((GCR_TypeDef *) (((0x40000000UL) + 0x10000000) + 0x00000))->PB_L_MFP &~(((uint32_t)0x00070000)|((uint32_t)0x00700000))|(((uint32_t)0x00010000)|((uint32_t)0x00100000)));
    ...
    UART_Init(((UART_TypeDef *) (((0x40000000UL) + 0x100000) + 0x50000)),&sParam);	
}
...
void SYS_Config(void)
{
    ...
    sChipClkCfg.u32HClkDiv   = (1 & 0x0F);     
     
    sChipClkCfg.u32AHBClkEn  = ((uint32_t)0x00000020) | ((uint32_t)0x00000001) | ((uint32_t)0x00000002);
    sChipClkCfg.u32APBClkEn  = ((uint32_t)0x00010000) | ((uint32_t)0x00020000) | ((uint32_t)0x00000004);
...
void pull_gpio()
{
	 ...
	 ((GCR_TypeDef *) (((0x40000000UL) + 0x10000000) + 0x00000))->PC_L_MFP &= ~0XFFFF;
	  
	 ((GPIO_TypeDef *) (((0x40000000UL) + 0x10000000) + 0x04080))->PMD&=~0XFF;
	  
	 ((GPIO_TypeDef *) (((0x40000000UL) + 0x10000000) + 0x04080))->PUEN |= 0xF;

	GPIO_DisablePullup(((GPIO_TypeDef *) (((0x40000000UL) + 0x10000000) + 0x04080)), 0);
    GPIO_DisablePullup(((GPIO_TypeDef *) (((0x40000000UL) + 0x10000000) + 0x04080)), 1);
    GPIO_DisablePullup(((GPIO_TypeDef *) (((0x40000000UL) + 0x10000000) + 0x04080)), 2);
    GPIO_DisablePullup(((GPIO_TypeDef *) (((0x40000000UL) + 0x10000000) + 0x04080)), 3);

	  
	 ((GCR_TypeDef *) (((0x40000000UL) + 0x10000000) + 0x00000))->PB_L_MFP &= ~(0X7<<24);
	 ((GPIO_TypeDef *) (((0x40000000UL) + 0x10000000) + 0x04040))->PMD&=~(0X3<<28);
	 ((GPIO_TypeDef *) (((0x40000000UL) + 0x10000000) + 0x04040))->PUEN |= 0X4000;
	 GPIO_DisableEINT1(((GPIO_TypeDef *) (((0x40000000UL) + 0x10000000) + 0x04040)), 14);
	 GPIO_DisablePullup(((GPIO_TypeDef *) (((0x40000000UL) + 0x10000000) + 0x04040)), 14);
