#line 1 "..\\API\\API_Lib\\rak_spi_set_psk.c"
...
#line 188 "..\\API\\API_Lib\\rak_global.h"
...
int RAK_revCMD(void* buf);
int16_t rak_init_struct(rak_api *ptrStrApi);
uint16_t rak_set_psk(rak_psk *PskFrame);
#line 29 "..\\API\\API_Lib\\rak_spi_set_psk.c"

#line 31 "..\\API\\API_Lib\\rak_spi_set_psk.c"
...
#line 32 "..\\API\\API_Lib\\rak_spi_set_psk.c"
...
uint16_t rak_set_psk(rak_psk *PskFrame)
{
	...
	PskFrame->cmd = 3;
	retval =  RAK_SndCMD(PskFrame, sizeof(rak_psk));
	return retval;
}
