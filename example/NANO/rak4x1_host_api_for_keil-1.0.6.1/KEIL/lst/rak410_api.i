#line 1 "..\\API\\API_Lib\\RAK410_API.c"
...
#line 3 "..\\API\\API_Lib\\RAK410_API.c"
...
#line 4 "..\\API\\API_Lib\\RAK410_API.c"
...
#line 5 "..\\API\\API_Lib\\RAK410_API.c"
...
int RAK_SendCMD(void* buf, uint16_t len);
...
int16_t rak_init_struct(rak_api *ptrStrApi);
#line 6 "..\\API\\API_Lib\\RAK410_API.c"
...
#line 8 "..\\API\\API_Lib\\RAK410_API.c"
#line 1 "..\\Libraries\\NANO1xx_Drivers\\Include\\nano1xx_spi.h"
...
#line 9 "..\\API\\API_Lib\\RAK410_API.c"
#line 1 "..\\Libraries\\NANO1xx_Drivers\\Include\\nano1xx_uart.h"
...
#line 10 "..\\API\\API_Lib\\RAK410_API.c"
#line 1 "..\\Libraries\\NANO1xx_Drivers\\Include\\nano1xx_gpio.h"
...
#line 11 "..\\API\\API_Lib\\RAK410_API.c"
#line 12 "..\\API\\API_Lib\\RAK410_API.c"
...
const char  GET_STATUS[4] =  {0X01, 0X97, 0X00, 0X00};
...
void spi_recv(char *re_data, uint16_t len)
{
    ...
    for (i=0; i < len; i++) { 
#line 38 "..\\API\\API_Lib\\RAK410_API.c"
        ...
        re_data[i] = ((SPI_TypeDef *) ((0x40000000UL) + 0x30000))->RX0;
...
uint8_t spi_send(uint8_t tx_data)
{
    ...
    ((SPI_TypeDef *) ((0x40000000UL) + 0x30000))->CTL |= ((uint32_t)0x00000001);
    while(((SPI_TypeDef *) ((0x40000000UL) + 0x30000))->CTL & ((uint32_t)0x00000001));
		while(!(((SPI_TypeDef *) ((0x40000000UL) + 0x30000))->STATUS & ((uint32_t)0x00000001)));
...
int RAK_revCMD(void* buf,uint16_t *length)
{
	*length = spi_send_head(0X04, 0);
	 spi_recv_data(buf,*length);
	 return 0;   
}
