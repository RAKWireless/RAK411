#line 1 "..\\API\\API_Lib\\src\\rak_config_init.c"
...
#line 7 "..\\API\\API_Lib\\src\\rak_config_init.c"
...
int16_t rak_init_struct(rak_api *ptrStrApi);
#line 8 "..\\API\\API_Lib\\src\\rak_config_init.c"
#line 9 "..\\API\\API_Lib\\src\\rak_config_init.c"
#line 10 "..\\API\\API_Lib\\src\\rak_config_init.c"
#line 11 "..\\API\\API_Lib\\src\\rak_config_init.c"
extern uint32_t 	 DIST_IP;
...
int16_t rak_init_struct(rak_api *ptrStrApi)
{
	...
	ptrStrApi->uScanFrame.channel = 0;
	strcpy((char *)&ptrStrApi->uScanFrame.ssid, "HUAWEI");

	
	strcpy((char *)&ptrStrApi->uPskFrame.psk, "1234567890");
	 
    
	ptrStrApi->uChannel.channel=7;
	
	
	ptrStrApi->uListenFrame.time = 100;
	
	
	ptrStrApi->uApconfigFrame.hidden = 0;
	strcpy((char *)&ptrStrApi->uApconfigFrame.countryCode, "CN");

	
	rak_asciiDotAddressTouint32((uint8_t *)&ptrStrApi->uIpstaticFrame.addr, (int8_t *)"192.168.7.1");
	rak_asciiDotAddressTouint32((uint8_t *)&ptrStrApi->uIpstaticFrame.mask, (int8_t *)"255.255.255.0");
	rak_asciiDotAddressTouint32((uint8_t *)&ptrStrApi->uIpstaticFrame.gw, (int8_t *)"192.168.7.1");
	rak_asciiDotAddressTouint32((uint8_t *)&ptrStrApi->uIpstaticFrame.dns1, (int8_t *)	"192.168.7.1");
	rak_asciiDotAddressTouint32((uint8_t *)&ptrStrApi->uIpstaticFrame.dns2, (int8_t *)	"0");	
	
	
	rak_asciiDotAddressTouint32((uint8_t *)&DIST_IP,"192.168.7.1");

	
	ptrStrApi->uIpdhcpFrame.mode= 0x00;

	
	ptrStrApi->uGetscan.scan_num=10;
	
	
	strcpy((char *)&ptrStrApi->uConnFrame.ssid, "RAK411_AP-CAO");
	ptrStrApi->uConnFrame.mode=	1;
	
	
	ptrStrApi->uPingFrame.count=5;
	ptrStrApi->uPingFrame.size=1000;	
	rak_asciiDotAddressTouint32((uint8_t *)&ptrStrApi->uPingFrame.hostaddr, (int8_t *)"192.168.11.1");
	
	
	strcpy((char *)&ptrStrApi->uDnsFrame.name, "www.baidu.com");

	
	ptrStrApi->uParamFrame.rak_param.net_type	 =1;
	ptrStrApi->uParamFrame.rak_param.channel	 =6;
	ptrStrApi->uParamFrame.rak_param.sec_mode	 =0;
	ptrStrApi->uParamFrame.rak_param.dhcp_mode 	 =0x01;
	strcpy((char *)&ptrStrApi->uParamFrame.rak_param.ssid, "RAK411_AP");
	strcpy((char *)&ptrStrApi->uParamFrame.rak_param.psk, "1234567890");
	ptrStrApi->uParamFrame.rak_param.dummy[0]=0;
	ptrStrApi->uParamFrame.rak_param.dummy[1]=0;
	rak_asciiDotAddressTouint32((uint8_t *)&ptrStrApi->uParamFrame.rak_param.ip_param.addr, (int8_t *)"192.168.11.122");
	rak_asciiDotAddressTouint32((uint8_t *)&ptrStrApi->uParamFrame.rak_param.ip_param.mask, (int8_t *)"255.255.255.0");
	rak_asciiDotAddressTouint32((uint8_t *)&ptrStrApi->uParamFrame.rak_param.ip_param.gw, (int8_t *)"192.168.11.1");
	rak_asciiDotAddressTouint32((uint8_t *)&ptrStrApi->uParamFrame.rak_param.ip_param.dns1, (int8_t *)	"192.168.11.1");
	rak_asciiDotAddressTouint32((uint8_t *)&ptrStrApi->uParamFrame.rak_param.ip_param.dns2, (int8_t *)	"0");	
	ptrStrApi->uParamFrame.rak_param.ap_param.hidden = 0;
	strcpy((char *)&ptrStrApi->uParamFrame.rak_param.ap_param.countryCode, "CN");
	
	
	 
	 
	strcpy((char *)&ptrStrApi->uWebFrame.user_name, "admin");
	strcpy((char *)&ptrStrApi->uWebFrame.user_psk, "admin");
	ptrStrApi->uWebFrame.net_params.net_type	 =1;
	ptrStrApi->uWebFrame.net_params.channel	 =6;
	ptrStrApi->uWebFrame.net_params.sec_mode	 =0;
	ptrStrApi->uWebFrame.net_params.dhcp_mode =0x01;
	strcpy((char *)&ptrStrApi->uWebFrame.net_params.ssid, "RAK411_AP");
	strcpy((char *)&ptrStrApi->uWebFrame.net_params.psk, "1234567890");
	ptrStrApi->uWebFrame.net_params.dummy[0]=0;
	ptrStrApi->uWebFrame.net_params.dummy[1]=0;
	rak_asciiDotAddressTouint32((uint8_t *)&ptrStrApi->uWebFrame.net_params.ip_param.addr, (int8_t *)"192.168.11.122");
	rak_asciiDotAddressTouint32((uint8_t *)&ptrStrApi->uWebFrame.net_params.ip_param.mask, (int8_t *)"255.255.255.0");
	rak_asciiDotAddressTouint32((uint8_t *)&ptrStrApi->uWebFrame.net_params.ip_param.gw, (int8_t *)"192.168.11.1");
	rak_asciiDotAddressTouint32((uint8_t *)&ptrStrApi->uWebFrame.net_params.ip_param.dns1, (int8_t *)	"192.168.11.1");
	rak_asciiDotAddressTouint32((uint8_t *)&ptrStrApi->uWebFrame.net_params.ip_param.dns2, (int8_t *)	"0");	
	ptrStrApi->uWebFrame.net_params.ap_param.hidden = 0;
	strcpy((char *)&ptrStrApi->uWebFrame.net_params.ap_param.countryCode, "CN");
...
uint32_t rak_bytes4ToUint32(uint8_t *dBuf)
{
	uint32_t				val;				
...
uint32_t rak_bytes4RToUint32(uint8_t *dBuf)
{
	uint32_t				val;				
